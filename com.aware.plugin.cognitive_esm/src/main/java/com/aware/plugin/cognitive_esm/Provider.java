...
public class Provider extends ContentProvider {
    ...
    public static final String DB_TBL_TEMPLATE = "cognitive";
    ...
    public static final class TableOne_Data implements AWAREColumns {
        ...
        public static final String CONTENT_TYPE = ContentResolver.CURSOR_DIR_BASE_TYPE + "/vnd.com.aware.plugin.cognitive_esm.provider.table_one"; //modify me
        public static final String CONTENT_ITEM_TYPE = ContentResolver.CURSOR_ITEM_BASE_TYPE + "/vnd.com.aware.plugin.cognitive_esm.provider.table_one"; //modify me
    ...
    public boolean onCreate() {
        ...
        AUTHORITY = getContext().getPackageName() + ".provider.cognitive"; //make sure xxx matches the first string in this class
